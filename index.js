...
let userNames = [
    {
        id: shortid.generate(),
        name: 'Pat',
        bio: 'student at lambda'
    },
    {
        id: shortid.generate(),
        name: 'Tucker',
        bio: 'tl and student at lambda'
    },
    {
        id: shortid.generate(),
        name: 'Luis',
        bio: 'Instructor at lambda'
    },
...
server.get('/api/users/:id', (req, res) => {
    ...
    if(user){
        ...
        const errorMessage = {
            message: "Sorry, the user wiith that ID does not exist"
        }
...
server.delete('/api/users/:id', (req, res) => {
    ...
    if (user){
       ...
       res.status(200).json(userNames);
        ...
        const errorMessage = {
            message: " The user withh that ID does not exist"
        }
